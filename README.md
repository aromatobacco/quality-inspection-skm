# Dashboard Quality Inspection SKM · v1.6.0
...
Jika halaman menyebut database belum siap, jalankan kembali `supabase-setup.sql` versi v1.6.0. File lama `skm_members` dan `skm_inspections`, bila pernah dibuat, tidak dihapus; versi ini memakai tabel baru agar data lama tidak rusak.

Developed @MT2026 · Last Version: v1.6.0 · 23 September 2026.
